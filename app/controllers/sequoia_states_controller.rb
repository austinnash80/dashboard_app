class SequoiaStatesController < ApplicationController
  ...
  private
    ...
    def sequoia_state_params
      params.require(:sequoia_state).permit(:state, :st, :list, :list_quantity, :matched, :market_share, :ce_cycle, :hours_per_cycle, :ce_due, :exp_date, :exp_cycle, :self_study, :has_year_minimum, :year_minimum)
    end
end
